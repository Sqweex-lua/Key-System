...
local Window = Rayfield:CreateWindow({
   Name = "📛DeleteWare📛",
   LoadingTitle = "Loading DeleteWare🙈",
   LoadingSubtitle = "t.me/deleteware",
   ConfigurationSaving = {
      Enabled = true,
   ...
   Discord = {
      Enabled = true,
      Invite = "t.me/deleteware", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
      RememberJoins = true -- Set this to false to make them join the discord every time they load it up
   },
   KeySystem = true, -- Set this to true to use our key system
   KeySettings = {
      Title = "t.me/deleteware",
      Subtitle = "Key System",
      Note = "Get key at t.me/deleteware",
      FileName = "Key", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = true, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"https://raw.githubusercontent.com/Sqweex-lua/Key-System/refs/heads/main/Keys.txt"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
Rayfield:Notify({
   Title = "Successfuly Injected | t.me/deleteware",
   Content = "DeleteWare Was Injected",
   Duration = 6.5,
   Image = 4483362458,
...
velocity.Name = "Spinbot"
        ...
        local Slider = MiscTab:CreateSlider({
           ...
           Callback = function(Value)
                ...
                local InfoTab = Window:CreateTab("🗣️Info", nil) -- Title, Image
                local InfoSection = InfoTab:CreateSection("🗣️Info")

               local Button = InfoTab:CreateButton({
                Name = "If You Need Help, join telegram",
                Callback = function()
                    print("1")
                end,
            })
            ...
            local Button = InfoTab:CreateButton({
                Name = "Первый мой скрипт сделаный на rayfield ui.",
                Callback = function()
                    print("t.me/deleteware")
                end,
            })
